...
from net.CSPdarknet53_tiny import darknet53_tiny
from net.attention import cbam_block, eca_block, se_block, CA_Block
...
class Upsample(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.upsample = nn.Sequential(
            ...
            nn.Upsample(scale_factor=2, mode='nearest') #图像上采样率为长宽各扩大2
        )
