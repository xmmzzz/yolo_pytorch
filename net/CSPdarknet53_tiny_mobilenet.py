...
class BasicMobileConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1):
        super(BasicMobileConv, self).__init__()
...
class Resblock_body(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = BasicMobileConv(in_channels, out_channels, 3)

        self.conv2 = BasicMobileConv(out_channels // 2, out_channels // 2, 3)
        self.conv3 = BasicMobileConv(out_channels // 2, out_channels // 2, 3)

        self.conv4 = BasicMobileConv(out_channels, out_channels, 1)
...
class CSPDarkNet(nn.Module):
    def __init__(self):
        ...
        # 13,13,512 -> 13,13,512
        self.conv3 = BasicMobileConv(512, 512, kernel_size=3)
